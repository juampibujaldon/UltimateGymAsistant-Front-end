    ...
    () =>
      language === "es"
        ? {
            ...
            setupSubtitle: "Como en FatSecret o MyFitnessPal: primero configurás tu perfil, luego la app te propone un objetivo diario claro.",
            age: "Edad",
            sex: "Sexo",
            male: "Hombre",
            female: "Mujer",
        ...
        : {
            ...
            setupSubtitle: "Like FatSecret or MyFitnessPal: set your profile first, then the app proposes a clear daily target.",
            age: "Age",
            sex: "Sex",
            male: "Male",
            female: "Female",
